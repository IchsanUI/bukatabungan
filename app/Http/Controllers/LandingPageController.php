...
class LandingPageController extends Controller
{
    ...
    {
        return view('./saving/digital-saving');
    }
    ...
    {
        return view('./saving/details-saving.detail-saving-1');
    }
    public function detail_2()
    {
        return view('./saving/details-saving.detail-saving-2');
    }
    public function detail_3()
    {
        return view('./saving/details-saving.detail-saving-3');
    }
