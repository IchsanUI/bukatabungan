    ...
    <div class="jumbotron jumbotron-fluid">
        <div class="detail-h">
            ...
            <div class="detail-h-info">
                ...
                <a href="{{ url('uker-choose') }}" class="btn btn-success btn-detail">Pilih Rekening<i
                    ...
                    <div class="tab-content py-3 px-3 px-sm-0" id="nav-tabContent">
                        <div class="tab-pane fade show active text-dark" id="nav-home" role="tabpanel"
                            ...
                            <div class="detail-decs">
                                ...
                                <p class="lh-1">Untuk Membuka Rekening Tabungan Umum di Bank Gresik, Berikut Adalah
