        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="card-info">
                    ...
                    <a href="{{ url('detail-saving-1') }}" class="btn btn-primary">Detail Tabungan<i class="bi bi-arrow-right-short" style="font-size: 1rem; color: white; margin-left: 0.5rem;"></i></a>
                </div>
            </div>
        </div>
